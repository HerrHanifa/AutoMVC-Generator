        ...
        <div class="col-12 px-0">
            <div class="col-12 p-0 row">
                <div class="col-12 col-lg-4 py-3 px-3">
                    <span class="fas fa-articles"></span> <th style="width:150px;">ratings</th>
                </div>
                <div class="col-12 col-lg-4 p-0">
                </div>
                <div class="col-12 col-lg-4 p-2 text-lg-endq">

                                   <a href="{{ route('rating.create.web') }}">
                ...
                <table class="table table-bordered  table-hover">
                    ...
                    @foreach($ratings as $rating)
                        <tr>
                            <td> </td>
                                                <td>{{ $rating->name }}</td>
                    <td>{{ $rating->name_en }}</td>
                    <td>{{ $rating->description }}</td>
                    <td>{{ $rating->description_en }}</td>

                            <td>
                                <a href="{{route('rating.edit.web', $rating->id)}}">
                                    <span class="btn btn-outline-success btn-sm font-small mx-1"><span class="fas fa-wrench"></span> تعديل </span>
                                </a>
                                       <a href="{{route('rating.delete.web', $rating->id)}}">
