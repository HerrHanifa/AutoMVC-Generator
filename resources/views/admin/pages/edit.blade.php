            ...
            <div class="col-12 col-lg-8 p-0 main-box">
                ...
                <div class="col-12 p-3 row">
                    ...
                    <div class="col-12 mt-3">
                        الصفحة تظهر أسفل <span style="color:red;">*</span>
                             </div>
                             <div class="col-12 pt-3">
                                 <select class="form-control select2-select" name="place"   size="1" style="height:30px;opacity: 0;">
                                     <option value=" ">أختر   </option>
                                     <option value="من نحن" @if($page->place=="من نحن" )   selected @endif>من نحن </option>
                                     <option value="المركز الاعلامي"  @if($page->place=="المركز الاعلامي" )   selected @endif>المركز الاعلامي</option>
                                     <option value="العضوية"  @if($page->place=="العضوية" )   selected @endif>العضوية</option>
