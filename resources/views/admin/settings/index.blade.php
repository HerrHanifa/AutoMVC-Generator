	 	...
	 	<div class="col-12 col-lg-8 px-3 py-5">
	 		...
	 		<div class="col-12 row p-0 taber active" id="general-tab">
				 ...
				 <div class="col-12 px-0 d-flex mb-3 row pb-3">
					...
					<div class="col-12 col-lg-9 px-2">
						<textarea name="settings[numclient]" class="form-control">{{$settings['numclient']}}</textarea>
					</div> 
				</div>
		 				<div class="col-12 px-0 d-flex mb-3 row pb-3">
		 			<div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
		 			...
		 			<div class="col-12 col-lg-9 px-2">
		 				<input type="" name="settings[numproject]" class="form-control" value="{{$settings['numproject']}}"  maxlength="190">
		 			</div> 
		 		</div>
				 <div class="col-12 px-0 d-flex mb-3 row pb-3">
					<div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
						الخبرة					</div>
					<div class="col-12 col-lg-9 px-2">
						<input type="" name="settings[experience]" class="form-control" value="{{$settings['experience']}}"  maxlength="190">
					</div> 
				</div>
	 		...
	 		<div class="col-12 row p-0 taber" id="appearance-tab">
				 ...
				 <div class="col-12 px-0 d-flex mb-3 row pb-3">
					...
					<div class="col-12 col-lg-9 px-2">
						<div class="form-check form-switch">
						<input type="hidden" name="settings[EnglishPr]" value="0" >
						 <input class="form-check-input" type="checkbox" id="EnglishPr" name="settings[EnglishPr]" {{$settings['EnglishPr']==1?'checked':""}} value="1">
					   </div>
					</div> 
				</div>
		 	</div>
