                    ...
                    <div class="col-12 p-3 row">
                        ...
                        @endif
                         ...
                         <div class="col-12 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea name="arabicPosition" class="form-control" style="min-height:150px">{{ old('arabicPosition') }}</textarea>
                            </div>
                          </div>
                           <div class="col-12 p-2">
                            <div class="col-12">
                            ...
                            <div class="col-12 pt-3">
                                <textarea name="position" class="form-control" style="min-height:150px">{{ old('position') }}</textarea>
                            </div>
                          </div>
