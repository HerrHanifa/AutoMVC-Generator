            ...
            <div class="col-12 col-lg-8 p-0 main-box">
                ...
                <div class="col-12 p-3 row">
                    ...
                    <div class="col-12 col-lg-6 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="text" name="title_en" required maxlength="190" class="form-control" value="{{old('title')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-12  p-2">
                        ...
                        <div class="col-12 pt-3">
                            <textarea name="description_en" class="editor with-file-explorer">{{old('description')}}</textarea>
                        </div>
                    </div>
                    <div class="col-12 p-2">
                        <div class="col-12">
