...
1200*/
        ...
        // $uploaded_file = $temp_file->addMedia($file)->toMediaCollection($options['type'])->store('public/media');
        $extension = $request->file('image')->getClientOriginalExtension();
        $customFileName =time(). '.' .$extension;
        $media = $request->file('image')->public_path('public/media', $customFileName);
...
// $url = url(Storage::url($uploaded_file));
